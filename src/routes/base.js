      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            exact: true,
            identity: 1,
            component: dynamicWrapper(app, [], () => import('../pages/Account/TeacherManage')),
          },
          {
            name: '添加教师',
            id: 'menu.account.teacher.add',
            key: 'add',
            path: 'teacher/add',
            isHide: true,
            identity: 1,
            component: dynamicWrapper(app, [], () => import('../pages/Account/TeacherAdd')),
          },
          // {
          //   name: '成为老师',
          //   id: 'menu.account.teacher',
